        ...
        <section class="box-order">
            <div class="row mg-0">
                ...
                <c:choose>
                    ...
                    <!-- Start Step order -->
                    <div class="order-steps order-steps order-steps-horizontal order-steps-small order-steps-label-horizontal pd-top-40" style="padding-bottom: 20px;">
                                        ...
                                        <div class="card-body" style="padding: 24px;">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    ...
                                                    <textarea id="note" class="form-control" placeholder="Nhập những gì bạn muốn vào đây." rows="10"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <c:otherwise>
                            ...
                            <div id="choose-login-order">
                                <div class="card bg-light mg-top-20 card-login">
                                    <div class="card-header bg-light order-card-head">Đăng nhập tài khoản Smart Trip</div>
                                        ...
                                        <div id="f-login">
                                            ...
                                            <f:form method="POST" modelAttribute="login" action="/order/login">
                                                <div class="form-group">
                                                    ...
                                                    <f:input required="true" path="username" cssClass="form-control" placeholder="Xin vui lòng điền tên đăng nhập" autofocus="true" />
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <f:password required="true" path="password" cssClass="form-control" placeholder="Xin vui lòng điền mật khẩu" data-eye="true" />
                                                </div>
                                                ...
                                                <div class="form-group no-margin">
                                                    <button type="submit" class="btn btn-outline-success my-2 my-sm-0 btn-order btn-custom" style="width: 100%;">
                                                        <span>Đăng nhập</span>
                                                    </button>
                                                </div>
                                            </f:form>
                                        ...
                                        <div id="f-register">
                                            <form>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control username" name="username" value="" placeholder="Xin vui lòng điền tên đăng nhập" required autofocus>
                                                </div>

                                                <div class="form-group">
                                                    <label>Mật khẩu</label>
                                                    <input type="password" class="form-control password" name="password" placeholder="Xin vui lòng điền mật khẩu" required data-eye>
                                                </div>

                                                <div class="form-group">
                                                    <label>Email</label>
                                                    <input type="email" class="form-control email" name="email" placeholder="Xin vui lòng điền địa chỉ email" required>
                                                </div>

                                                <div class="form-group">
                                                    <label>Họ và Tên</label>
                                                    <input type="text" class="form-control name" name="name" value="" placeholder="Xin vui lòng điền họ và tên" required>
                                                </div>

                                                <div class="form-group">
                                                    <label>Số điện thoại</label>
                                                    <input type="tel" pattern="[0-9]{10}" class="form-control phone" name="phone" placeholder="Xin vui lòng điền số điện thoại" value="" required>
                                                </div>

                                                <div class="mg-bottom-10" style="display: flow-root;">
                                                    <a href="#" class="btn-login t_right">Đăng nhập</a>
                                                    <span class="t_right">|</span>
                                                    <a href="#" class="btn-forgot-password t_right">Quên mật khẩu?</a>
                                                </div>
                                                ...
                                                <div class="form-group no-margin">
                                                    ...
                                                    <center class="cfs-14 c_gray" style="padding: 0px 40px;">Khi tạo tài khoản Smart Trip xem như bạn đã đồng ý với điều khoản dịch vụ</center>
                                                </div>
                                            </form>
                                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <!-- Start Card order-->
                    <div class="card">
                        <img class="card-img-top" src="<c:url value="/resources/images/${sessionScope.processOrder.picture}" />" alt="Card image cap">
                        <div class="card-body">

                            <div class="card bg-light">
                                <div class="card-header bg-light order-card-head">
                                    <h4 class="cfs-20" style="font-weight: bolder;">${sessionScope.processOrder.tour}</h4>
                                </div>
                                <div class="card-body card-order">
                                    <div class="row pd-bottom-10 mg-0">
                                        <div class="col-lg-12 pd-0">
                                            <h4 class="c_gray cfs-14"><i class="fa fa-plane" aria-hidden="true"></i> Gói dịch vụ</h4>
                                        </div>
                                        <div class="col-lg-12 pd-0">
                                    ...
                                    <div class="row l_top pd-bottom-10 pd-top-10 mg-0">
                                        <div class="col-lg-12 pd-0">
                                            <h4 class="c_gray cfs-14"><i class="fa fa-calendar" aria-hidden="true"></i> Ngày</h4>
                                        </div>
                                        <div class="col-lg-12 pd-0">
                                    ...
                                    <div class="row l_top pd-bottom-10 pd-top-10 mg-0">
                                        <div class="col-lg-12 pd-0">
                                            <h4 class="c_gray cfs-14"><i class="fa fa-users" aria-hidden="true"></i> Số lượng</h4>
                                        </div>
                                    </div>
                                    <div class="row mg-0">
                                        ...
                                        <c:forEach items="${sessionScope.processOrder.ticketDetail}" var="ticketDetail">
                                            <div class="row pd-top-10 pd-bottom-10 mg-0" style="width: 100%;">
                                                ...
                                                <div class="col-lg-4 col-sm-12 pd-0 service-price">
                                                    <h4 class="c_black t_right cfs-14">${ticketDetail.priceTicket} ₫</h4>
                                                </div>
                                            </div>
                                        </c:forEach>
