    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="box-blog-right mg-top-20">
                ...
                <div class="box-blog-content">
                    <c:forEach items="${listPostFood}" var="lPostFood">
                        <article class="blog-post-item">
                            <div class="blog-media-object">
                                <a class="blog-image-holder" href="/blog/${lPostFood.postID}">
                                    <img src="/resources/images/${lPostFood.postImage}" alt="">
                                </a>
                                <div class="blog-post-content">
                                    <h3 class="blog-post-title cfs-15">
                                        <a href="/blog/${lPostFood.postID}">${lPostFood.postTitle}</a>
                                    </h3>
                                    <div class="blog-post-meta">
                                    <span class="cfs-12"><i class="fa fa-clock-o"
                                                            aria-hidden="true"></i>${lPostFood.date}</span>
                                        <span class="cfs-12"><i class="fa fa-eye" aria-hidden="true"></i>${lPostFood.postView}</span>
                                    </div>
                                </div>
                            </div>
                        </article>
