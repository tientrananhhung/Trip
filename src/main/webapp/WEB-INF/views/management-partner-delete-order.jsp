...
<head>
    ...
    <title>Quản lý đơn hàng đã hủy - Smart Trip</title>
    <!-- Icon -->
    ...
    <section class="right-body-info">
        <div class="right-content-info">
            <div class="content-title-info">
                <h3 class="c_orange cfs-22">Quản lý đơn hàng đã hủy</h3>
            </div>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                        ...
                        <c:forEach items="${listOrder}" var="order">
                            <tr>
                                ...
                                <td>
                                    <fmt:formatNumber type="number" pattern="###,###" value="${order.totalPriceAfter}"/>
                                    đ
                                </td>
                                <td>${order.note}</td>
                                <td>
                                    <c:choose>
                                        <c:when test="${order.purchased == true && order.deleted == true}">
                                            <a href="/quan-ly/hoan-tien/${order.orderID}"
                                               class="btn btn-outline-danger btn-sm">Hoàn tiền</a>
                                        </c:when>
