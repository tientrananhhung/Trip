...
<head>
    ...
    <title>Quản lý bài viết - Smart Trip</title>
    <!-- Icon -->
    ...
    <section class="right-body-info">
        <div class="right-content-info">
            <div class="content-title-info">
                <h3 class="c_orange cfs-22">Quản lý bài viết  <a href="/quan-ly/bai-viet/them" class="btn btn-warning btn-rounded btn-fw float-right">Thêm bài viết</a></h3>
            </div>
                ...
                <div class="tbl-content">
                    <table cellpadding="0" cellspacing="0" border="0">
                        ...
                        <c:forEach items="${listPost}" var="post">
                            <tr>
                                <td>
                                    <img src="/resources/images/${post.image}" alt="Avatar Smart Trip" class="rounded-circle" style="width:45px;height: 45px;"  id="output">
                                </td>
                                <td>${post.title}</td>
                                <td>${post.categoryname}</td>
                                <td>${post.description}</td>
                                <td>
                                    <a href="/quan-ly/bai-viet/sua/${post.id}/"
                                       class="btn btn-outline-success btn-sm">Sửa</a>
                                    <a onclick="if (confirm('Bạn có thực sự muốn xóa ?')){return true;}else{event.stopPropagation(); event.preventDefault();};" href="/quan-ly/bai-viet/xoa/${post.id}/"
