...
public class MailContent {
    ...
    public static String ACTIVE_PARTNER(String customername,String name, String phone,String address,String email) {
        String body = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\"><head>\n" +
                ...
                " <div class=\"\">\n" +
                "\t<div style=\"color:#283C4B;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%; padding-right: 30px; padding-left: 30px; padding-top: 10px; padding-bottom: 10px;\">\t\n" +
                "\t\t<div style=\"font-size:12px;line-height:18px;color:#283C4B;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;\"><p style=\"margin: 0;font-size: 12px;line-height: 18px;text-align: center\"><span style=\"font-size: 16px; line-height: 24px;\"><strong><span style=\"font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px;\">Xin chào: " + customername + "</span></strong></span></p><p style=\"margin: 0;font-size: 12px;line-height: 18px;text-align: center\"><span style=\"font-size: 16px; line-height: 24px;\" mce-data-marked=\"1\"><strong><span style=\"font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px;\" mce-data-marked=\"1\">Dưới đây là thông tin đối tác của bạn:</span></strong></span></p></div>\t\n" +
                "\t</div>\n" +
                "</div>        \n" +
                "    <div class=\"\">\n" +
                "\t<div style=\"color:#283C4B;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%; padding-right: 30px; padding-left: 30px; padding-top: 10px; padding-bottom: 0px;\">\t\n" +
                ...
                "<div class=\"\">\n" +
                "\t<div style=\"color:#283C4B;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%; padding-right: 30px; padding-left: 30px; padding-top: 10px; padding-bottom: 0px;\">\t\n" +
                "\t\t<div style=\"font-size:12px;line-height:18px;color:#283C4B;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;\"><p style=\"margin: 0;font-size: 12px;line-height: 18px\"><span style=\"font-size: 14px; line-height: 21px;\">Tên đối tác: " + name + "</span></p></div>\t\n" +
                "\t</div>\n" +
                "</div>\n" +
                "<div class=\"\">\n" +
                "\t<div style=\"color:#283C4B;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%; padding-right: 30px; padding-left: 30px; padding-top: 10px; padding-bottom: 0px;\">\t\n" +
                "\t\t<div style=\"font-size:12px;line-height:18px;color:#283C4B;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;\"><p style=\"margin: 0;font-size: 12px;line-height: 18px\"><span style=\"font-size: 14px; line-height: 21px;\">Phone: "+phone+"</span></p></div>\t\n" +
                "\t</div>\n" +
                "</div>\n" +
                "<div class=\"\">\n" +
                "\t<div style=\"color:#283C4B;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%; padding-right: 30px; padding-left: 30px; padding-top: 10px; padding-bottom: 0px;\">\t\n" +
                "\t\t<div style=\"font-size:12px;line-height:18px;color:#283C4B;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;\"><p style=\"margin: 0;font-size: 12px;line-height: 18px\"><span style=\"font-size: 14px; line-height: 21px;\">Địa chỉ: "+address+"</span></p></div>\t\n" +
                "\t</div>\n" +
                "</div>\n" +
                "<div class=\"\">\n" +
                "\t<div style=\"color:#283C4B;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%; padding-right: 30px; padding-left: 30px; padding-top: 10px; padding-bottom: 0px;\">\t\n" +
        ...
        public static String PURCHASED(OrderDTO orderDTO){
        String ticket = "";
        for(TicketDetailDTO ticketDetailDTO:orderDTO.getTicketDetailDTOList()){
            ticket = ticket + " <tr class=\"item\">\n" +
                    "                <td class=\"ta-l\">\n" +
                    "                    "+ticketDetailDTO.getNameTicket()+"\n" +
                    "                </td>\n" +
                    "                <td>\n" +
                    "                    "+ticketDetailDTO.getPriceTicket()+"\n đ" +
                    "                </td>\n" +
                    "                <td>\n" +
                    "                    "+ticketDetailDTO.getQuantityTicket()+"" +
                    "                </td>\n" +
                    "                <td>\n" +
                    "                    "+ StringUtils.formatCurrency(String.valueOf(Integer.parseInt(ticketDetailDTO.getPriceTicket().replaceAll("\\.", "")) * ticketDetailDTO.getQuantityTicket()))+" đ" +
                    "                </td>\n" +
                    "            </tr>";
        }
        String body = "<!doctype html>\n" +
                ...
                "<head>\n" +
                "    <meta charset=\"utf-8\">\n" +
                "    <title>Smarttrip - Xác nhận thanh toán</title>\n" +
                "    \n" +
                "    <style>\n" +
                "    .invoice-box {\n" +
                "        max-width: 800px;\n" +
                ...
                "                        <tr>\n" +
                "                            <td class=\"title\">\n" +
                "                                <img src=\"https://i.imgur.com/BqDzzL6.png\" style=\"width:100%; max-width:300px;\">\n" +
                "                            </td>\n" +
                "                            \n" +
                ...
                "                        <tr>\n" +
                "                             <td>\n" +
                "                                "+ orderDTO.getTourName()+"<br>\n" +
                "                                "+ orderDTO.getServiceName()+"<br>\n" +
                "                                "+ orderDTO.getTourAddress()+"" +
                "                            </td>\n" +
                "                           <td style=\"text-align: right;\">\n" +
                "                                "+orderDTO.getCustomerName()+"<br>\n" +
                "                               "+orderDTO.getPhoneUser()+"<br>\n" +
                ...
                "                   Tổng tiền: "+StringUtils.formatCurrency(orderDTO.getTotalPriceAfter())+"\n đ" +
                "                </td>\n" +
                "            </tr>\n" +
                "        </table>\n" +
                "    </div>\n" +
